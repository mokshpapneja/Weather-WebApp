...
let app=Vue.createApp({
    ...
    methods:{
        CityWeather(){
            console.log(document.querySelector("#geocoder > div > input").value);
            this.City=document.querySelector("#geocoder > div > input").value.split(",")[0];
...
mapboxgl.accessToken = 'pk.eyJ1IjoibW9rc2hwYXBuZWphIiwiYSI6ImNrdWUzcTVhdDFna24yb28zcThjeWhtaWIifQ.lZPA_23LFVvp8i19Kr4weA';
